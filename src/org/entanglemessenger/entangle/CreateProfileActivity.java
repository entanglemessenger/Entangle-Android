...
import org.entanglemessenger.entangle.profiles.ProfileMediaConstraints;
import org.entanglemessenger.entangle.profiles.SystemProfileUtil;
...
import org.entanglemessenger.entangle.util.IntentUtils;
...
public class CreateProfileActivity extends BaseActionBarActivity implements InjectableType {
  ...
  private void initializeResources() {
    ...
    informationLabel.setOnClickListener(view -> {
      ...
      intent.setData(Uri.parse("https://entanglemessenger.org"));
  ...
  private Intent createAvatarSelectionIntent(@Nullable File captureFile, boolean includeClear, boolean includeCamera) {
    ...
    if (includeClear) {
      extraIntents.add(new Intent("org.entanglemessenger.entangle.action.CLEAR_PROFILE_PHOTO"));
    }
