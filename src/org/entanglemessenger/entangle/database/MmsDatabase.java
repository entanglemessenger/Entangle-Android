...
import org.entanglemessenger.entangle.attachments.MmsNotificationAttachment;
...
import org.entanglemessenger.entangle.database.documents.IdentityKeyMismatchList;
import org.entanglemessenger.entangle.database.documents.NetworkFailure;
import org.entanglemessenger.entangle.database.documents.NetworkFailureList;
import org.entanglemessenger.entangle.database.helpers.SQLCipherOpenHelper;
import org.entanglemessenger.entangle.database.model.MediaMmsMessageRecord;
import org.entanglemessenger.entangle.database.model.MessageRecord;
import org.entanglemessenger.entangle.database.model.NotificationMmsMessageRecord;
import org.entanglemessenger.entangle.database.model.Quote;
import org.entanglemessenger.entangle.jobmanager.JobManager;
import org.entanglemessenger.entangle.jobs.TrimThreadJob;
import org.entanglemessenger.entangle.mms.IncomingMediaMessage;
...
import org.entanglemessenger.entangle.util.JsonUtils;
...
import static org.entanglemessenger.entangle.contactshare.Contact.Avatar;
import static org.entanglemessenger.entangle.contactshare.Contact.deserialize;
...
//  }
  ...
  public void markIncomingNotificationReceived(long threadId) {
    ...
    if (org.entanglemessenger.entangle.util.Util.isDefaultSmsProvider(context)) {
      DatabaseFactory.getThreadDatabase(context).incrementUnread(threadId, 1);
    }
  ...
  public class Reader implements Closeable {
    ...
    private NotificationMmsMessageRecord getNotificationMmsMessageRecord(Cursor cursor) {
      ...
      if (!TextUtils.isEmpty(contentLocation))
        contentLocationBytes = org.entanglemessenger.entangle.util.Util.toIsoBytes(contentLocation);

      if (!TextUtils.isEmpty(transactionId))
        transactionIdBytes = org.entanglemessenger.entangle.util.Util.toIsoBytes(transactionId);
