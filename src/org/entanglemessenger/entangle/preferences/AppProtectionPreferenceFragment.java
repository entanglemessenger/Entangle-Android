...
import org.entanglemessenger.entangle.BlockedContactsActivity;
import org.entanglemessenger.entangle.PassphraseChangeActivity;
import org.entanglemessenger.entangle.R;
import org.entanglemessenger.entangle.components.SwitchPreferenceCompat;
...
import org.entanglemessenger.entangle.lock.RegistrationLockDialog;
...
public class AppProtectionPreferenceFragment extends CorrectedPreferenceFragment implements InjectableType {
  ...
  public void onCreate(Bundle paramBundle) {
    ...
    this.findPreference(getString(R.string.preferences__privacy_policy)).setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
      @Override
      public boolean onPreferenceClick(Preference preference) {
        startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://entanglemessenger.org/privacy-policy")));
        return true;
      }
    });
