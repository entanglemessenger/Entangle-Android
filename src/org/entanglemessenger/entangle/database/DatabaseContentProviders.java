...
public class DatabaseContentProviders {
    ...
    public static class ConversationList extends NoopContentProvider {
        public static final Uri CONTENT_URI = Uri.parse("content://org.entanglemessenger.entangle.database.conversationlist");
    }

    public static class Conversation extends NoopContentProvider {
        private static final String CONTENT_URI_STRING = "content://org.entanglemessenger.entangle.database.conversation/";
    ...
    public static class Attachment extends NoopContentProvider {
        public static final Uri CONTENT_URI = Uri.parse("content://org.entanglemessenger.entangle.database.attachment");
    }

    public static class Sticker extends NoopContentProvider {
        public static final Uri CONTENT_URI = Uri.parse("content://org.entanglemessenger.entangle.database.sticker");
    }

    public static class StickerPack extends NoopContentProvider {
        public static final Uri CONTENT_URI = Uri.parse("content://org.entanglemessenger.entangle.database.stickerpack");
    }
