...
import org.entanglemessenger.entangle.mms.PartUriParser;
import org.entanglemessenger.entangle.service.KeyCachingService;
import org.entanglemessenger.entangle.util.MemoryFileUtil;
...
public class PartProvider extends ContentProvider {
  ...
  private static final String CONTENT_URI_STRING = "content://org.entanglemessenger.provider.entangle/part";
  ...
  static {
    ...
    uriMatcher.addURI("org.entanglemessenger.provider.entangle", "part/*/#", SINGLE_ROW);
  }
