...
import org.entanglemessenger.entangle.service.UpdateApkReadyListener;
import org.entanglemessenger.entangle.util.FileUtils;
...
public class UpdateApkJob extends ContextJob {
  ...
  private void handleDownloadStart(String uri, String versionName, byte[] digest) {
    ...
    downloadRequest.setTitle("Downloading Entangle update");
    downloadRequest.setDescription("Downloading Entangle " + versionName);
    downloadRequest.setVisibleInDownloadsUi(false);
    downloadRequest.setDestinationInExternalFilesDir(context, null, "entangle-update.apk");
