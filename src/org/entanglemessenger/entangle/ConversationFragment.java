...
import org.entanglemessenger.entangle.ConversationAdapter.HeaderViewHolder;
import org.entanglemessenger.entangle.ConversationAdapter.ItemClickListener;
import org.entanglemessenger.entangle.contactshare.ContactUtil;
import org.entanglemessenger.entangle.contactshare.SharedContactDetailsActivity;
...
import org.entanglemessenger.entangle.database.loaders.ConversationLoader;
...
import org.entanglemessenger.entangle.profiles.UnknownSenderView;
...
import org.entanglemessenger.entangle.util.SaveAttachmentTask;
import org.entanglemessenger.entangle.util.SaveAttachmentTask.Attachment;
import org.entanglemessenger.entangle.util.StickyHeaderDecoration;
import org.entanglemessenger.entangle.util.ViewUtil;
import org.entanglemessenger.entangle.util.task.ProgressDialogAsyncTask;
  ...
  implements LoaderManager.LoaderCallbacks<Cursor>
{
  ...
  private class ConversationFragmentItemClickListener implements ItemClickListener {
    ...
    public void onInviteSharedContactClicked(@NonNull List<Recipient> choices) {
      ...
      ContactUtil.selectRecipientThroughDialog(getContext(), choices, locale, recipient -> {
        CommunicationActions.composeSmsThroughDefaultApp(getContext(), recipient.getAddress(), getString(R.string.InviteActivity_lets_switch_to_signal, "https://www.entanglemessenger.org/"));
      });
    }
  }
