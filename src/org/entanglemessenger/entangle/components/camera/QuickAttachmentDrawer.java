package org.entanglemessenger.entangle.components.camera;
...
import org.entanglemessenger.entangle.components.KeyboardAwareLinearLayout;
import org.entanglemessenger.entangle.components.camera.CameraView.CameraViewListener;
...
public class QuickAttachmentDrawer extends ViewGroup implements InputView, CameraViewListener {
  ...
  protected boolean drawChild(@NonNull Canvas canvas, @NonNull View child, long drawingTime) {
    boolean result;
    //PQC//final int save = canvas.save(Canvas.CLIP_SAVE_FLAG);
